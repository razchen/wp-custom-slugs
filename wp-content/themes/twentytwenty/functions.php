...
function custom_rewrite_tag() {
	add_rewrite_tag('%specialty%', '([^&]+)');
	add_rewrite_tag('%frieda%', '([^&]+)');
  }
  add_action('init', 'custom_rewrite_tag', 10, 0);

  function custom_rewrite_rule() {
	add_rewrite_rule('^lists/([^/]*)/([^/]*)?','index.php?page_id=9&specialty=$matches[1]&frieda=$matches[2]','top');
	add_rewrite_rule('^lists/([^/]*)/?','index.php?page_id=7&specialty=$matches[1]','top');
  }
